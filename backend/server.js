...
/* ================= MEDIA ================= */
import { generateImage } from "./aix-core/executors/media/imageGenerator.js";
...
app.post("/api/aix", async (req, res) => {
  try {
    ...
    if (
      ...
      const img = generateImage(command.goal);
      updateState("Image generated");

      return res.json({
        command,
        plan,
        result: "Image generated by AIX",
        imageUrl: img,
        state: getState()
      });
    }
